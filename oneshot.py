...
def cmd_bootstrap(args: argparse.Namespace) -> int:
    ...
    print()
    print(f"    {_c('Run a OneShot for this:', DIM)}")
    print(f"    {_c('<your prompt, specs, project, goal, etc.>', DIM)}")
    print(f"    {_c('Before starting, check whether the current workspace contains', DIM)}")
    print(f"    {_c('OneShot repo files: SYSTEM.md, skills/orchestrator.md, vault/.', DIM)}")
