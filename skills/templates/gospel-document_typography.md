=== VISUAL SPECIFICATION CONTRACT (document_typography) ===
...
Medium extension axis: format_register={format_register}
...
TOKEN FAMILIES:
- `type_scale` must be implemented from manifest tokens.
- `page_grid` must be implemented from manifest tokens.
- `margin_system` must be implemented from manifest tokens.
- `leading_rules` must be implemented from manifest tokens.
- `widow_orphan_rules` must be implemented from manifest tokens.
- `chart_styling` must be implemented from manifest tokens.
- `color_narrative` must be implemented from manifest tokens.
...
- If format_register is set, preserve its medium-specific idiom in every runtime artifact.
...
- Preserve `type_scale` values exactly unless a Visual Specification amendment changes them.
- Preserve `page_grid` values exactly unless a Visual Specification amendment changes them.
- Preserve `margin_system` values exactly unless a Visual Specification amendment changes them.
- Preserve `leading_rules` values exactly unless a Visual Specification amendment changes them.
- Preserve `widow_orphan_rules` values exactly unless a Visual Specification amendment changes them.
- Preserve `chart_styling` values exactly unless a Visual Specification amendment changes them.
- Preserve `color_narrative` values exactly unless a Visual Specification amendment changes them.
