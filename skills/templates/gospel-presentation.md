=== VISUAL SPECIFICATION CONTRACT (presentation) ===
...
Medium extension axis: narrative_arc={narrative_arc}
...
TOKEN FAMILIES:
- `slide_grid` must be implemented from manifest tokens.
- `stage_spotlight` must be implemented from manifest tokens.
- `type_on_stage` must be implemented from manifest tokens.
- `slide_color` must be implemented from manifest tokens.
- `transition` must be implemented from manifest tokens.
- `build_pacing` must be implemented from manifest tokens.
...
- If narrative_arc is set, preserve its medium-specific idiom in every runtime artifact.
...
- Preserve `slide_grid` values exactly unless a Visual Specification amendment changes them.
- Preserve `stage_spotlight` values exactly unless a Visual Specification amendment changes them.
- Preserve `type_on_stage` values exactly unless a Visual Specification amendment changes them.
- Preserve `slide_color` values exactly unless a Visual Specification amendment changes them.
- Preserve `transition` values exactly unless a Visual Specification amendment changes them.
- Preserve `build_pacing` values exactly unless a Visual Specification amendment changes them.
