=== VISUAL SPECIFICATION CONTRACT (data_visualization) ===
...
Medium extension axis: narrative_chart={narrative_chart}
...
TOKEN FAMILIES:
- `chart_grammar` must be implemented from manifest tokens.
- `color_scale` must be implemented from manifest tokens.
- `type_on_chart` must be implemented from manifest tokens.
- `chart_density` must be implemented from manifest tokens.
- `annotation_vocabulary` must be implemented from manifest tokens.
...
- If narrative_chart is set, preserve its medium-specific idiom in every runtime artifact.
...
- Preserve `chart_grammar` values exactly unless a Visual Specification amendment changes them.
- Preserve `color_scale` values exactly unless a Visual Specification amendment changes them.
- Preserve `type_on_chart` values exactly unless a Visual Specification amendment changes them.
- Preserve `chart_density` values exactly unless a Visual Specification amendment changes them.
- Preserve `annotation_vocabulary` values exactly unless a Visual Specification amendment changes them.
