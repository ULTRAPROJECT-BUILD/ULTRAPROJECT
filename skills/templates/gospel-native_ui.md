=== VISUAL SPECIFICATION CONTRACT (native_ui) ===
...
Medium extension axis: platform_native={platform_native}
...
TOKEN FAMILIES:
- `dynamic_type_scale` must be implemented from manifest tokens.
- `color` must be implemented from manifest tokens.
- `spacing` must be implemented from manifest tokens.
- `corner_radius` must be implemented from manifest tokens.
- `elevation` must be implemented from manifest tokens.
- `motion` must be implemented from manifest tokens.
- `safe_area_insets` must be implemented from manifest tokens.
- `focus` must be implemented from manifest tokens.
- `materials` must be implemented from manifest tokens.
...
- If platform_native is set, preserve its medium-specific idiom in every runtime artifact.
...
- Preserve `dynamic_type_scale` values exactly unless a Visual Specification amendment changes them.
- Preserve `color` values exactly unless a Visual Specification amendment changes them.
- Preserve `spacing` values exactly unless a Visual Specification amendment changes them.
- Preserve `corner_radius` values exactly unless a Visual Specification amendment changes them.
- Preserve `elevation` values exactly unless a Visual Specification amendment changes them.
- Preserve `motion` values exactly unless a Visual Specification amendment changes them.
- Preserve `safe_area_insets` values exactly unless a Visual Specification amendment changes them.
- Preserve `focus` values exactly unless a Visual Specification amendment changes them.
- Preserve `materials` values exactly unless a Visual Specification amendment changes them.
