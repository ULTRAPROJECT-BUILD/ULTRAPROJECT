...
A small, end-to-end run that exercises most of the ULTRAPROJECT pipeline — creative brief, design contract, code build, self-review, quality check, polish review, and delivery.
