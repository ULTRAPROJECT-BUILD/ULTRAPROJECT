...
- **Benchmarks**: If the brief or media contract expects benchmark/comparison screenshots, create `.stitch/designs/benchmarks/` and save the named benchmark images there during this stage. Do not leave benchmark capture as an implied later task.
