...
- If the brief/media contract expects benchmark/comparison screenshots, refresh the corresponding files under `.stitch/designs/benchmarks/` too so self-review and QC inherit current visual proof instead of stale or missing artifacts.
